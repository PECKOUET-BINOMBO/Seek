...
<body>
    <style>
    .navbar-light .navbar-nav .location_link {
        color: #ec3e0e;
    }
    </style>
        ...
        <div class="row">
            ...
            <div class="mycards">
                ...
                if (isset($_POST['+r'])) {
                    $oui = "oui";
                    $statuts = "en cours";
                    $req = $loginData->prepare("SELECT * FROM annonces WHERE categories = 'location' AND valider = ? AND statuts = ? ORDER BY id_annonces DESC");
                    ...
                    elseif (isset($_POST['-r'])) {
                        $oui = "oui";
                        $statuts = "en cours";
                        $req = $loginData->prepare("SELECT id_annonces, id_annonceurs, categories, types, titres, descriptions, prix, img_cover, quartiers, villes, options, date_add, date_expire, valider FROM annonces WHERE categories = 'location' AND valider = ? AND statuts = ? ORDER BY id_annonces ASC");
                        $req->execute(array($oui, $statuts));
                    ...
                    elseif (isset($_POST['+c'])) {
                        $oui = "oui";
                        $statuts = "en cours";
                        $req = $loginData->prepare("SELECT * FROM annonces WHERE categories = 'location' AND valider = ? AND statuts = ? ORDER BY prix DESC");
                        $req->execute(array($oui, $statuts));
                        $reqcount = $req->rowCount();
                    ...
                    elseif (isset($_POST['-c'])) {
                        $oui = "oui";
                        $statuts = "en cours";
                        $req = $loginData->prepare("SELECT * FROM annonces WHERE categories = 'location' AND valider = ? AND statuts = ? ORDER BY prix ASC");
                        $req->execute(array($oui, $statuts));
                ...
                elseif(isset($_POST['pj'])){
                    $oui = "oui";
                    $statuts = "en cours";
                    $req = $loginData->prepare("SELECT * FROM annonces WHERE categories = 'location' AND periode = 'Jour' AND valider = 'oui' AND statuts = 'en cours'");
                    $req->execute();
                    $reqcount = $req->rowCount();
                ...
                elseif(isset($_POST['ps'])){
                    $oui = "oui";
                    $statuts = "en cours";
                    $req = $loginData->prepare("SELECT * FROM annonces WHERE categories = 'location' AND periode = 'Semaine' AND valider = 'oui' AND statuts = 'en cours'");
                    $req->execute();
                    $reqcount = $req->rowCount();
                ...
                elseif(isset($_POST['pm'])){
                                $oui = "oui";
                                $statuts = "en cours";
                                $req = $loginData->prepare("SELECT * FROM annonces WHERE categories = 'location' AND periode = 'Mois' AND valider = 'oui' AND statuts = 'en cours'");
                                $req->execute();
                                $reqcount = $req->rowCount();
