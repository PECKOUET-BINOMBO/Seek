        ...
        <div class="row">
            ...
            <div class="mycards">
                ...
                if (isset($_POST['+r'])) {
                    $oui = "oui";
                    $statuts = "en cours";
                    $req = $loginData->prepare("SELECT * FROM annonces WHERE types = ? valider = ? AND statuts = ? ORDER BY id_annonces DESC");
                    $req->execute(array($type_page, $oui, $statuts));
                    ...
                    elseif (isset($_POST['-r'])) {
                        $oui = "oui";
                        $statuts = "en cours";
                        $req = $loginData->prepare("SELECT * FROM annonces WHERE types = ? valider = ? AND statuts = ? ORDER BY id_annonces ASC");
                        $req->execute(array($type_page, $oui, $statuts));
                    ...
                    elseif (isset($_POST['+c'])) {
                        $oui = "oui";
                        $statuts = "en cours";
                        $req = $loginData->prepare("SELECT * FROM annonces WHERE types = ? valider = ? AND statuts = ? ORDER BY prix DESC");
                        $req->execute(array($type_page, $oui, $statuts));
                        $reqcount = $req->rowCount();
                    ...
                    elseif (isset($_POST['-c'])) {
                        $oui = "oui";
                        $statuts = "en cours";
                        $req = $loginData->prepare("SELECT * FROM annonces WHERE types = ? valider = ? AND statuts = ? ORDER BY prix ASC");
                        $req->execute(array($type_page, $oui, $statuts));
                ...
                elseif(isset($_POST['pj'])){
                    $oui = "oui";
                    $statuts = "en cours";
                    $req = $loginData->prepare("SELECT * FROM annonces WHERE types = ? periode = 'Jour' AND valider = 'oui' AND statuts = 'en cours'");
                    $req->execute(array($type_page));
                    $reqcount = $req->rowCount();
                ...
                elseif(isset($_POST['ps'])){
                    $oui = "oui";
                    $statuts = "en cours";
                    $req = $loginData->prepare("SELECT * FROM annonces WHERE types = ? periode = 'Semaine' AND valider = 'oui' AND statuts = 'en cours'");
                    $req->execute(array($type_page));
                    $reqcount = $req->rowCount();
                ...
                elseif(isset($_POST['pm'])){
                                $oui = "oui";
                                $statuts = "en cours";
                                $req = $loginData->prepare("SELECT * FROM annonces WHERE types = ? periode = 'Mois' AND valider = 'oui' AND statuts = 'en cours'");
                                $req->execute(array($type_page));
                                $reqcount = $req->rowCount();
