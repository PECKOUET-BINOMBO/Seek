...
<head>
    ...
    <title>Annonces à <?= $page_ville ?></title>
...
<body>
    ...
    <div class="container-fluid-xs container-xxl pd">
        <div class="row">
            ...
            <div class="row" style="padding-right: calc(var(--bs-gutter-x) * 0) !important; 
                padding-left: calc(var(--bs-gutter-x) * 0);">
                <div class="container-fluid box-location  p-0" style=" padding-right: calc(var(--bs-gutter-x) * 0)
                    !important;"">
                  
                    <!-- bg & filtre-->
                    <section class=" bg-filtre">
                    <h1>Nos annonces: <?= $page_ville ?></h1>
                    </section>
                    <h5 id="h3scroll" class=" mb-3 py-1 px-3 " style="background-color: #0b2239; color:#fff;">
                        Afficher
                        par
                        <div class="dropdown">
            ...
            <div class="mycards">
                ...
                if (isset($_POST['+r'])) {
                    ...
                    $req->execute(array($page_ville, $oui, $statuts));
                ...
                elseif(isset($_POST['pj'])){
                    $oui = "oui";
                    $statuts = "en cours";
                    $req = $loginData->prepare("SELECT * FROM annonces WHERE villes = ? AND periode = 'Jour' AND valider = 'oui' AND statuts = 'en cours'");
                    $req->execute(array($page_ville));
                    $reqcount = $req->rowCount();
                ...
                elseif(isset($_POST['ps'])){
                    $oui = "oui";
                    $statuts = "en cours";
                    $req = $loginData->prepare("SELECT * FROM annonces WHERE villes = ? AND periode = 'Semaine' AND valider = 'oui' AND statuts = 'en cours'");
                    $req->execute(array($page_ville));
                    $reqcount = $req->rowCount();
                ...
                elseif(isset($_POST['pm'])){
                                $oui = "oui";
                                $statuts = "en cours";
                                $req = $loginData->prepare("SELECT * FROM annonces WHERE villes = ? AND periode = 'Mois' AND valider = 'oui' AND statuts = 'en cours'");
                                $req->execute(array($page_ville));
                                $reqcount = $req->rowCount();
