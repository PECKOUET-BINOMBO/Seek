            ...
            <div class="container mt-5 mb-5 p-0">
                <div class="row justify-content-center">
                    <div class="col-12 col-md-6 mx-2 border morebox">
                        ...
                        <div class="d-flex">
                        <?php if ($data['statuts'] === "en cours de validation..." && $data['valider'] === "non") : ?>
                            <div>
                                <a title="Valider l'annonce" class="bg-success text-light px-1 mx-1" style="padding:5%; text-decoration:none; border-radius:5px; display:inline-block" href="valider.php?id=<?= $rec ?>&annonce=<?= $rec2 ?>">Accepter </a>
                            </div>
                            <div>
                                <a title="Refuser l'annonce" class="bg-danger text-light  px-1 mx-1" style="padding:5%; text-decoration:none; border-radius:5px; display:inline-block" href="refuser.php?id=<?= $rec ?>&annonce=<?= $rec2 ?>">Refuser</a>
                            </div>
                        <?php endif; ?>
                        <?php if ($data['statuts'] === "en cours" && $data['valider'] === "oui") : ?>
                            <div>
                                <a title="Supprimer l'annonce" class="bg-danger text-light  px-1 mx-1" style="padding:5%; text-decoration:none; border-radius:5px; display:inline-block" href="refuser.php?id=<?= $rec ?>&annonce=<?= $rec2 ?>">Supprimer
                                </a>
                            </div>
                            <div>
                                <a title="Réviser l'annonce" class="bg-primary text-light  px-1 mx-1" style="padding:5%; text-decoration:none; border-radius:5px; display:inline-block" href="reviser.php?id=<?= $rec ?>&annonce=<?= $rec2 ?>">Reviser</a>
                            </div>
